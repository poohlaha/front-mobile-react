...
const PageNotFound: React.FC<IRouterProps> = (props: IRouterProps) => {
  return (
    <div className="not-found-page wh100 flex-direction-column overflow-hidden">
      <div className="not-found-content flex-direction-column flex-center flex-1 no-permission">
        <svg className="not-found-pic">
          <defs>
        ...
        <p className="no-found-subtitle">Sorry, the page you visited does not exist.</p>
        <div
          className="back-button flex-center cursor-pointer"
          onClick={() => PAGE_JUMP.toWindowPage(RouterUrls.SYSTEM.HOME_URL, true, true)}
        >
          返回首页
        </div>
      </div>
